...
- [ ] Создать репозиторий `adapty-clone` на GitHub (public)
- [ ] Инициализировать локальный git: `git init`
- [ ] Связать с remote: `git remote add origin`
- [ ] Создать .gitignore
- [ ] Первый коммит с документацией
...
|------|--------|-----------|
| 0. Git репозиторий | ⏳ Ожидает | 0% |
| 1. Настройка проекта | ⏳ Ожидает | 0% |
...
**Фаза 0.1:** Создание Git репозитория
...
gh repo create adapty-clone --public --source=. --remote=origin
